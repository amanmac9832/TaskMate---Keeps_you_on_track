...
SECRET_KEY = 'ba9e15076296529b9b5ce30fdcc97296568c2c9cf383251fe6fa6758adf87ef8'
ALGORITHM = 'HS256'
...
templates = Jinja2Templates(directory="TaskMate/templates")
...
def create_access_token(username: str, user_id: int, role: str, expiers_delta: timedelta):
...
async def create_user(db: db_dependency, 
                      create_request_user: CreateUserRequest):
  create_request_model = Users(
